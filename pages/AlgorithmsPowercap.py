...
__completePath__ = os.path.join(APP_ROOT, f"../static/results/powercap/algorithms_clean.csv")
__meanPath__ = os.path.join(APP_ROOT, f"../static/results/powercap/algorithms_averages.csv")
